<?php $html->addCrumb("Content pages", array('controller'=>'contentpages','action'=>'index'));?><?php $html->addCrumb("Edit content page", array());?> 
<?php e($javascript->link('fckeditor/fckeditor')); ?>
<div class="mainBox mainBoxborder curveEdges">
	<div class="block">
		<div class="header"><h1 class="fleft"><?php __('Edit content page');?></h1>
			<ul>

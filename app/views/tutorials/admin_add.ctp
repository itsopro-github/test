<?php $html->addCrumb("Tutorials", array('controller'=>'tutorials','action'=>'index'));?><?php $html->addCrumb("Add new tutorial", array());?>
<div class="mainBox mainBoxborder curveEdges">
	<div class="block">
		<div class="header"><h1 class="fleft"><?php __('Add new tutorial');?></h1>
			<ul>
			...
			<?php echo $form->create('Tutorial',array('enctype'=>'multipart/form-data'));?>
				<table class="formtable">
					<tr>
						...
						<td width="20%">
						<?php __($form->input('title', array('label'=>false,'class'=>'text','maxlength'=>'125','error'=>false))); ?></td>
					...
					<tr>
						<td><label>Upload tutorial<span class="mandatory">*</span></label></td>

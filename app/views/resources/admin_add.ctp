...
<?php $html->addCrumb("Add new resource", array());?>
<div class="mainBox mainBoxborder curveEdges">
	<div class="block">
		<div class="header"><h1 class="fleft"><?php __('Add new resource');?></h1>
			<ul>
			...
			<?php echo $form->create('Resource',array('enctype'=>'multipart/form-data'));?>
				<table class="formtable">
					<tr>
						...
						<td width="20%"><?php __($form->input('title', array('label'=>false,'class'=>'text','maxlength'=>'125','error'=>false))); ?></td>
					...
					<tr>
						...
						<td colspan="3"><?php __($form->input('description', array('label'=>false,'cols'=>'115','error'=>false,'div'=>false))); ?></td>
					</tr>
					<tr>
						<td><label>Upload resource file</label></td>

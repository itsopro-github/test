<?php $html->addCrumb("News", array('controller'=>'news','action'=>'index'));?><?php $html->addCrumb("Add news", array());?>
<div class="mainBox mainBoxborder curveEdges">
	<div class="block">
		<div class="header"><h1 class="fleft"><?php __('Add news');?></h1>
			<ul>
			...
			<?php echo $form->create('News',array('enctype'=>'multipart/form-data'));?>
				<table class="formtable">
					<tr>
						...
						<td><?php __($form->input('title', array('label'=>false,'class'=>'text','maxlength'=>'125','error'=>false))); ?></td>

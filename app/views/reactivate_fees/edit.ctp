...
<?php echo $this->Form->create('ReactivateFee');?>
	<fieldset>
 		<legend><?php __('Edit Reactivate Fee'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ReactivateFee.id')), null, sprintf('Are you sure you want to delete # %s?', $this->Form->value('ReactivateFee.id'))); ?></li>

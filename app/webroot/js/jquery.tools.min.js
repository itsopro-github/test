 ...
 * 
 * [tabs, tooltip, scrollable, overlay, dateinput]
 * 
 * NO COPYRIGHTS OR LICENSES. DO WHAT YOU LIKE.
 * 
 * http://flowplayer.org/tools/
 * 
 * File generated: Sat Jun 12 23:38:09 GMT 2010
 */
(function (c) {
    function p(e, b, a) {
        var d = this,
        ...
        else if (a.initialIndex === 0 || a.initialIndex > 0) d.click(a.initialIndex)
    }
    c.tools = c.tools || {
        version: "1.2.3"
    };
...
(function (d) {
    ...
    function Z(b, c) {
        ...
        function m(a) {
            ...
            d(document).bind("keydown.d", function (e) {
                ...
                if (d(V).index(g) >= 0) {
                    ...
                    if (g == 74 || g == 40) q += 7;
                    else if (g == 75 || g == 38) q -= 7;
                    else if (g == 76 || g == 39) q += 1;
                    else if (g == 72 || g == 37) q -= 1;
                    if (q == -1) {
                        h.addMonth(-1);
                        p = d("#" + f.weeks + " a:last")
                    } else if (q == 35) {
        ...
        var h = this,
            ...
            k = d("#" + f.root),
            L = k.find("#" + f.title),
            K, I, J, D, E, G, l = b.attr("data-value") || c.value || b.val(),
            r = b.attr("min") || c.min,
            s = b.attr("max") || c.max,
            u;
        l = C(l) || t;
        ...
        if (!k.length) {
           ...
           // if (c.selectors) {
                ...
                L.append(z.add(A))
           // }
            for (var $ = k.find("#" + f.days), N = 0; N < 7; N++) $.append(d("<span/>").text(o.shortDays[(N + c.firstDay) % 7]));
            b.after(k)
        }
        ...
        d.extend(h, {
            show: function (a) {
              ...
              //  if (c.selectors) {
                    ...
                    A.empty();
                    for (i = a + c.yearRange[0]; i < a + c.yearRange[1]; i++) r < new Date(i + 1, -1, 0) && s > new Date(i, 0, 0) && A.append(d("<option/>").text(i));
                    z.val(e);
                    A.val(a)
            //    } else L.html(o.months[e] + " " + a);
                ...
                for (var w = 0, n, x; w < 42; w++) {
                    ...
                    if (w < g) {
                        ...
                        x = w - g + 1;
                        i = new Date(a, e, x);
                        if (U(l, i)) n.attr("id", f.current).addClass(f.focus);
                        else U(t, i) && n.attr("id", f.today)
                    }
